...
data class BudgetRecordDto(
    @Min(1900) val year: Int,
    @Min(1) @Max(12) val month: Int,
    @Min(1) val amount: Int,
    val type: BudgetType,
    var fullNameAuthor: String? = null,
    var dateOfCreate: DateTime? = null
)
...
data class BudgetYearParam(
    ...
    @QueryParam("Фильтр по ФИО") var filter: String? = null
)

class BudgetYearStatsResponse(
    val total: Int,
    val totalByType: Map<String, Int>,
    val items: List<BudgetRecordDto>
)
